...
d3.json('/get-data', function(err, data){
        ...
        data1 = []
        data1.push({ group: "Left", variable: "RUN", value: parseFloat(data['prob_left_run']+data['prob_short_left_pass']+data['prob_long_left_pass']), upperci: parseFloat(data['prob_left_run_lowerci']+data['prob_short_left_pass_upperci']+data['prob_long_left_pass_upperci']), lowerci: parseFloat(data['prob_left_run_upperci']+data['prob_short_left_pass_lowerci']+data['prob_long_left_pass_lowerci'])})
        data1.push({ group: "Middle", variable: "RUN", value: parseFloat(data['prob_middle_run']+data['prob_short_middle_pass']+data['prob_long_middle_pass']), upperci: parseFloat(data['prob_middle_run_lowerci']+data['prob_short_middle_pass_upperci']+data['prob_long_middle_pass_upperci']), lowerci: parseFloat(data['prob_middle_run_upperci']+data['prob_short_middle_pass_lowerci']+data['prob_long_middle_pass_lowerci'])})
        data1.push({ group: "Right", variable: "RUN", value: parseFloat(data['prob_right_run']+data['prob_short_right_pass']+data['prob_long_right_pass']), upperci: parseFloat(data['prob_right_run_lowerci']+data['prob_short_right_pass_upperci']+data['prob_long_right_pass_upperci']), lowerci: parseFloat(data['prob_right_run_upperci']+data['prob_short_right_pass_lowerci']+data['prob_long_right_pass_lowerci'])})
